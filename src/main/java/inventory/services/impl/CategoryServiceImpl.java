        ...
        try {
            if (jwtFilter.isAdmin()){
                ...
                if (!optional.isPresent()){
                    return InventoryUtils.getResponseEntity("Category id does not exist", HttpStatus.OK);

                }else {
                    categoryDao.save(getCategoryFromMap(requestMap,true));
                    return InventoryUtils.getResponseEntity("Category updated successfully", HttpStatus.OK);
                }
                }
